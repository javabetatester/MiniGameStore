...
public class BibliotecaJogos {
    ...
    public static void main(String[] args) {
        ...
        Jogo j1 = new Jogo("Senhor dos Anais", "Hobbit", "Fantasia", "23/02/1992", 13, 400, 50);

        // Instancia um jogo "FIFA" com gênero "Soft", classificação etária 13 anos
        Jogo j2 = new Jogo("FIFA", "Jutis", "Soft", "05/09/2001", 13, 400, 50);
        ...
        Jogo j4 = new Jogo("LOL", "Huti", "Lulis", "13/08/2002", 13, 400, 50);
